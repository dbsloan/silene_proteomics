...
arabidopsis = read.csv("aars_enrichment.arabidopsis.withLFQ.noPF2.csv")
silene = read.csv("aars_enrichment.silene.LFQ.noPF.csv")
...
write.csv(combined_df, "combined_df_LFQ.noPF.csv", row.names = FALSE)
...
ggsave("aaRS_differential_enrichment.LFQ.noPF.pdf", width=3.25, height=4)
